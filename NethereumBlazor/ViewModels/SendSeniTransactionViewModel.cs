...
{
    public class SendSeniTransactionViewModel : SendTransactionBaseViewModel
    {
        ...
        public SendSeniTransactionViewModel(IAccountsService accountsService) : base(accountsService)
        {
            _decimalPlaces = 18;
            _contractAddress = "0xC3E7623133c4E5f73e5068FbB85E492b74667C6a";
